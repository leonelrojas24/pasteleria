...
<form action ="azucar.php" method="POST">
...
echo"<center><h2>Cucharadas:".round($cdtas,2)."</h2></center>";
...
echo"<center><h2>Cucharadas:".round($cdas,2)."</h2></center>";
echo"<center><h2>Tazas:".round($tazas,2)."</h2></center>";
echo"<center><h2>Gramos:".round($gramos,2)."</h2></center>";
}
...
echo"<center><h2>Cucharadas:".round($cdas,2)."</h2></center>";
echo"<center><h2>Cucharditas:".round($cdtas,2)."</h2></center>";
echo"<center><h2>Gramos:".round($gramos,2)."</h2></center>";
}
...
echo"<center><h2>Cucharaditas:".round($cdas,2)."</h2></center>";
echo"<center><h2>Cucharaditas:".round($cdtas,2)."</h2></center>";
echo"<center><h2>Tazas:".round($tazas,2)."</h2></center>";
}
